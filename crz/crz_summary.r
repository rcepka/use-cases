...
Tables:
1. All contracts
2. All contracts summary
3. All contracts cleaned - data tidied
4. Sammaries by years and by years&months
...
# *******************************************************************************
# 2. Summaries table, total contracts, total sum, average contract size, highest contract, etc..
# *******************************************************************************
